...
@version: 3.X
@Author: hu_xz
@Date: 2020-05-18 09:55:31
@LastEditors: hu_xz
@LastEditTime: 2020-06-10 17:58:32
'''
#
...
class Solution(object):
    def numIslands(self, grid):
        ...
        def dfs(row, col):
            ...
            if row < len(grid) - 1 and grid[row+1][col] == '1': dfs(row+1, col)
            if col < len(grid[0]) - 1 and grid[row][col+1] == '1': dfs(row, col+1)
